...
class _JobsPageState extends State<JobsPage>
  ...
  //   final double tabBarHeight = kToolbarHeight; // 56
  //   final double chipsHeight = 40;
  //   final double titleHeight = 38;
  //   final double searchRowHeight = 64;
  //   final double headerPadding = 16 + 8 + 12; // paddings between widgets
  ...
  //                   minExtentHeight: tabBarHeight,
  //                   maxExtentHeight: maxHeaderHeight,
  //                   // builder: (shrinkOffset, overlapsContent) {
  //                   //   // Animate the header's content opacity and size
  //                   //   final percent = (1 -
  //                   //           (shrinkOffset / (maxHeaderHeight - tabBarHeight)))
  //                   //       .clamp(0.0, 1.0);
  ...
  //                   //             ),
  //                   //           ),
  //                   //         // TabBar always pinned at the bottom of header
  //                   //         TabBar(
  ...
  //                         (maxHeaderHeight - tabBarHeight) * percent;
  ...
  //                         crossAxisAlignment: CrossAxisAlignment.start,
  //                         children: [
  //                           // Animated header content (title, search, chips)
  //                           ClipRect(
  //                             child: Align(
  //                               alignment: Alignment.topCenter,
  //                               heightFactor: percent,
  //                               child: SizedBox(
  //                                 height: maxHeaderHeight - tabBarHeight,
  //                                 child: Column(
  //                                   crossAxisAlignment:
