...
class _HomePageState extends State<HomePage> {
  ...
  final List<String> _applicationStatuses = ['All Jobs', 'Applied', 'Not Applied'];
...
Widget build(BuildContext context) {
              ...
              return Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      border: Border.all(color: const Color(0xFF3D47D1), width: 2),
                    ),
                    child: CircleAvatar(
                      radius: 18,
                      backgroundColor: Colors.black,
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  _buildNavItem(0, Icons.work_outline, 'Jobs'),
                  _buildNavItem(1, Icons.assignment_turned_in_outlined, 'Applied'),
                  _buildNavItem(2, Icons.person_outline, 'Profile'),
                ],
              ),
            ),
  ...
  //         // Filter Box Overlay covering everything including bottom nav bar
  //         if (_showGlobalFilterBox)
  //           Positioned.fill(
  //             child: Material(
  //               color: Colors.black.withOpacity(0.32),
  ...
  //                   child: Container(
  //                     width: MediaQuery.of(context).size.width * 0.93,
  //                     // Prevent tap propagation inside filter box
  //                     child: GestureDetector(
  //                       onTap: () {},
  //                       child: JobFilterBox(
  //                         currentFilters: _currentFilters,
