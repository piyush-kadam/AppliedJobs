...
class _JobFilterBoxState extends State<JobFilterBox> {
  ...
  void initState() {
    super.initState();
selectedJobRole = widget.currentFilters.jobRole;
selectedLocation = widget.currentFilters.location;
selectedStatus = widget.currentFilters.applicationStatus;
selectedCompany = widget.currentFilters.companies.isNotEmpty ? widget.currentFilters.companies.first : null;
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Companies (merged list, radio list)
                Align(
                  alignment: Alignment.centerLeft,
                  child: Text(
                    'Companies',
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    onPressed: () {
                      setState(() {
                        selectedJobRole = widget.jobRoles.isNotEmpty ? widget.jobRoles.first : null;
                        selectedLocation = widget.locations.isNotEmpty ? widget.locations.first : null;
                        selectedStatus = widget.applicationStatuses.isNotEmpty ? widget.applicationStatuses.first : null;
                        selectedCompany = null;
                        selectedJobTypes.clear();
                      });
                      widget.onClear();
